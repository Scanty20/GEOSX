...
Ifpack::EPrecType getIfpackPrecondType( LinearSolverParameters::PrecondType const & type )
{
  static std::map< LinearSolverParameters::PrecondType, Ifpack::EPrecType > const typeMap =
  {
    { LinearSolverParameters::PrecondType::iluk, Ifpack::ILU },
    { LinearSolverParameters::PrecondType::ilut, Ifpack::ILUT },
    { LinearSolverParameters::PrecondType::ic, Ifpack::IC },
    { LinearSolverParameters::PrecondType::ict, Ifpack::ICT },
    { LinearSolverParameters::PrecondType::chebyshev, Ifpack::CHEBYSHEV },
    { LinearSolverParameters::PrecondType::jacobi, Ifpack::POINT_RELAXATION },
    { LinearSolverParameters::PrecondType::gs, Ifpack::POINT_RELAXATION },
    { LinearSolverParameters::PrecondType::sgs, Ifpack::POINT_RELAXATION },
    { LinearSolverParameters::PrecondType::direct, Ifpack::AMESOS }
  };

  GEOSX_LAI_ASSERT_MSG( typeMap.count( type ) > 0, "Unsupported Trilinos/Ifpack preconditioner option: " << type );
  return typeMap.at( type );
}
string getIfpackRelaxationType( LinearSolverParameters::PrecondType const & type )
{
  static std::map< LinearSolverParameters::PrecondType, string > const typeMap =
  {
    { LinearSolverParameters::PrecondType::jacobi, "Jacobi" },
    { LinearSolverParameters::PrecondType::gs, "Gauss-Seidel" },
    { LinearSolverParameters::PrecondType::sgs, "symmetric Gauss-Seidel" },
  };
...
EpetraMatrix const & TrilinosPreconditioner::setupSeparateComponent( EpetraMatrix const & mat )
{
  if( m_params.preconditionerType == LinearSolverParameters::PrecondType::amg && m_params.amg.separateComponents )
  {
...
{
  EpetraMatrix const & precondMat = setupSeparateComponent( mat );
  ...
  switch( m_params.preconditionerType )
  {
    ...
    case LinearSolverParameters::PrecondType::gs:
    case LinearSolverParameters::PrecondType::sgs:
    case LinearSolverParameters::PrecondType::chebyshev:
    case LinearSolverParameters::PrecondType::iluk:
    case LinearSolverParameters::PrecondType::ilut:
    case LinearSolverParameters::PrecondType::ic:
    case LinearSolverParameters::PrecondType::ict:
