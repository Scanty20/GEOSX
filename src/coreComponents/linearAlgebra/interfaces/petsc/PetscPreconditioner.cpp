...
PCType getPetscSmootherType( LinearSolverParameters::PrecondType const & type )
{
  static std::map< LinearSolverParameters::PrecondType, PCType > const typeMap =
  {
    { LinearSolverParameters::PrecondType::iluk, PCILU },
    { LinearSolverParameters::PrecondType::ic, PCICC },
    { LinearSolverParameters::PrecondType::jacobi, PCJACOBI },
    { LinearSolverParameters::PrecondType::l1jacobi, PCJACOBI },
    { LinearSolverParameters::PrecondType::gs, PCSOR },
    { LinearSolverParameters::PrecondType::sgs, PCSOR },
    { LinearSolverParameters::PrecondType::l1sgs, PCSOR },
  };
...
PCJacobiType getPetscJacobiType( LinearSolverParameters::PrecondType const & type )
{
  static std::map< LinearSolverParameters::PrecondType, PCJacobiType > const typeMap =
  {
    { LinearSolverParameters::PrecondType::jacobi, PC_JACOBI_DIAGONAL },
    { LinearSolverParameters::PrecondType::l1jacobi, PC_JACOBI_ROWSUM },
  };
...
MatSORType getPetscSORType( LinearSolverParameters::PrecondType const & type )
{
  static std::map< LinearSolverParameters::PrecondType, MatSORType > const typeMap =
  {
    { LinearSolverParameters::PrecondType::gs, SOR_FORWARD_SWEEP },
    { LinearSolverParameters::PrecondType::sgs, SOR_SYMMETRIC_SWEEP },
    { LinearSolverParameters::PrecondType::l1sgs, SOR_SYMMETRIC_SWEEP },
  };
...
PetscMatrix const & PetscPreconditioner::setupSeparateComponent( PetscMatrix const & mat )
{
...
{
  PetscMatrix const & precondMat = setupSeparateComponent( mat );
