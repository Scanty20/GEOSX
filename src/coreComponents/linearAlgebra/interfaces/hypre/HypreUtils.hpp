 ...
 */
inline HYPRE_Int toInt( geosx::integer const index )
{
 ...
 * @return the converted value
 */
inline HYPRE_BigInt toBigInt( geosx::globalIndex const index )
{
 ...
 * @return the converted array
 */
inline HYPRE_BigInt const * toBigInt( geosx::globalIndex const * const index )
{
