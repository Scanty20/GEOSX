...
private:
   ...
   */
  HypreMatrix const & setupSeparateComponent( HypreMatrix const & mat );

  /// Parameters for all preconditioners
  LinearSolverParameters m_params;

  /// SC approximation matrix
  HypreMatrix m_separateComponentMatrix;

  /// Pointers to hypre preconditioner and correspondoing setup/solve/destroy preconditioner
